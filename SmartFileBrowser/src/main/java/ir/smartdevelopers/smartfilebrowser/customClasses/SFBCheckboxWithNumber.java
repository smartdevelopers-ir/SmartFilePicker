    ...
    private void init(Context context,AttributeSet attr) {
        ...
        if (attr !=null ){
            ...
            try {
                 ...
                 mFillColor=typedArray.getColor(R.styleable.SFBCheckboxWithNumber_fillColor,Color.parseColor("#00b8e9"));
                 mStrokeColor=typedArray.getColor(R.styleable.SFBCheckboxWithNumber_strokeColor,Color.WHITE);
                 mStrokeWidth=typedArray.getDimension(R.styleable.SFBCheckboxWithNumber_strokeWidth,12);
                 mTextColor=typedArray.getColor(R.styleable.SFBCheckboxWithNumber_android_textColor,Color.WHITE);
