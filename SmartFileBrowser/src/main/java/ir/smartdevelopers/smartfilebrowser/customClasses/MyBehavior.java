...
public class MyBehavior <V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public abstract static class BottomSheetCallback {
         ...
         */
        public abstract void onStateChanged(@NonNull View bottomSheet, @MyBehavior.State int newState);
    ...
    @NonNull private final ArrayList<MyBehavior.BottomSheetCallback> callbacks = new ArrayList<>();
    ...
    public MyBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        peekHeightGestureInsetBuffer =
                context.getResources().getDimensionPixelSize(com.google.android.material.R.dimen.mtrl_min_touch_target_size);
        ...
        if (a.hasValue(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_android_maxWidth)) {
            setMaxWidth(
                    a.getDimensionPixelSize(
                            com.google.android.material.R.styleable.BottomSheetBehavior_Layout_android_maxWidth, NO_WIDTH));
        }
        ...
        setHalfExpandedRatio(
                a.getFloat(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_behavior_halfExpandedRatio, 0.5f));
        ...
        paddingBottomSystemWindowInsets =
                a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_paddingBottomSystemWindowInsets, false);
        paddingLeftSystemWindowInsets =
                a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_paddingLeftSystemWindowInsets, false);
        paddingRightSystemWindowInsets =
                a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_paddingRightSystemWindowInsets, false);
        // Setting this to false will prevent the bottomsheet from going below the status bacom.google.android.material.R. Since
        // this is a breaking change from the old behavior the default is true.
        paddingTopSystemWindowInsets =
                a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_paddingTopSystemWindowInsets, true);
    ...
    public Parcelable onSaveInstanceState(@NonNull CoordinatorLayout parent, @NonNull V child) {
        return new MyBehavior.SavedState(super.onSaveInstanceState(parent, child), this);
    }
...
//        nestedScrollingChildRef = new WeakReference<>(findScrollingChild(child));
     ...
     * @attr ref com.google.android.material.R.styleable#MyBehavior_Layout_android_maxWidth
     * @see #getMaxWidth()
     */
     ...
     * @attr ref
     *     com.google.android.material.R.styleable#MyBehavior_Layout_behavior_peekHeight
     */
     ...
     * @attr ref
     *     com.google.android.material.R.styleable#MyBehavior_Layout_behavior_halfExpandedRatio
     */
     ...
     * @attr ref
     *     com.google.android.material.R.styleable#MyBehavior_Layout_behavior_expandedOffset
     */
     ...
     * @attr ref com.google.android.material.R.styleable#MyBehavior_Layout_behavior_hideable
     */
     ...
     * @attr ref
     *     com.google.android.material.R.styleable#MyBehavior_Layout_behavior_skipCollapsed
     */
     ...
     * @attr ref com.google.android.material.R.styleable#MyBehavior_Layout_behavior_draggable
     */
     ...
     * @see #getSaveFlags()
     * @attr ref com.google.android.material.R.styleable#MyBehavior_Layout_behavior_saveFlags
     */
    public void setSaveFlags(@MyBehavior.SaveFlags int flags) {
     ...
     * @deprecated use {@link #addBottomSheetCallback(MyBehavior.BottomSheetCallback)} and {@link
     *     #removeBottomSheetCallback(MyBehavior.BottomSheetCallback)} instead
     */
    @Deprecated
    public void setBottomSheetCallback(MyBehavior.BottomSheetCallback callback) {
        Log.w(
                TAG,
                "MyBehavior now supports multiple callbacks. `setBottomSheetCallback()` removes"
     ...
     * @param callback The callback to notify when bottom sheet events occur.
     */
    public void addBottomSheetCallback(@NonNull MyBehavior.BottomSheetCallback callback) {
     ...
     */
    public void removeBottomSheetCallback(@NonNull MyBehavior.BottomSheetCallback callback) {
     ...
     */
    public void setState(@MyBehavior.State int state) {
        if (state == this.state) {
            return;
        }
        if (viewRef == null) {
    ...
    private void settleToStatePendingLayout(@MyBehavior.State int state) {
    ...
    void setStateInternal(@MyBehavior.State int state) {
        if (this.state == state) {
            return;
        }
        this.state = state;
    ...
    private void updateDrawableForTargetState(@MyBehavior.State int state) {
        if (state == STATE_SETTLING) {
    ...
    private void restoreOptionalState(@NonNull MyBehavior.SavedState ss) {
    ...
    void startSettlingAnimation(View child, int state, int top, boolean settleFromViewDragHelper) {
        ...
        if (startedSettling) {
            ...
            if (settleRunnable == null) {
                ...
                settleRunnable = new MyBehavior.SettleRunnable(child, state);
            }
    ...
    private final ViewDragHelper.Callback dragCallback =
            new ViewDragHelper.Callback() {
                ...
                public void onViewReleased(@NonNull View releasedChild, float xvel, float yvel) {
                    int top;
                    @MyBehavior.State int targetState;
                    if (yvel < 0) { // Moving up
                        if (fitToContents) {
                            top = fitToContentsOffset;
                            targetState = STATE_EXPANDED;
    ...
    private class SettleRunnable implements Runnable {
        ...
        SettleRunnable(View view, @MyBehavior.State int targetState) {
            this.view = view;
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull MyBehavior<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link MyBehavior#SAVE_PEEK_HEIGHT}, {@link
         * MyBehavior#SAVE_FIT_TO_CONTENTS}, {@link MyBehavior#SAVE_HIDEABLE}, {@link
         * MyBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link MyBehavior#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link #SavedState(Parcelable, MyBehavior)} instead.
         */
        @Deprecated
        ...
        public static final Creator<MyBehavior.SavedState> CREATOR =
                new ClassLoaderCreator<MyBehavior.SavedState>() {
                    @NonNull
                    @Override
                    public MyBehavior.SavedState createFromParcel(@NonNull Parcel in, ClassLoader loader) {
                        return new MyBehavior.SavedState(in, loader);
                    }

                    @Nullable
                    @Override
                    public MyBehavior.SavedState createFromParcel(@NonNull Parcel in) {
                        return new MyBehavior.SavedState(in, null);
                    }
    ...
    /**
     * A utility function to get the {@link MyBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link MyBehavior}.
     * @return The {@link MyBehavior} associated with the {@code view}.
     */
    @NonNull
    @SuppressWarnings("unchecked")
    public static <V extends View> MyBehavior<V> from(@NonNull V view) {
        ...
        if (!(behavior instanceof MyBehavior)) {
            throw new IllegalArgumentException("The view is not associated with MyBehavior");
        }
        return (MyBehavior<V>) behavior;
    }
        ...
        if (!fitToContents && state != STATE_HALF_EXPANDED) {
            expandHalfwayActionId =
                    addAccessibilityActionForState(
                            child, com.google.android.material.R.string.bottomsheet_action_expand_halfway, STATE_HALF_EXPANDED);
        }
