...
public class SFBCheckBoxWithTick extends AppCompatCheckBox {
    ...
    void init(@NonNull Context context, @Nullable AttributeSet attrs){
        if (Build.VERSION.SDK_INT>=21){
            ...
            Drawable checkedDrawable= VectorDrawableCompat.create(getResources(),R.drawable.check_box_checked,context.getTheme());
            Drawable uncheckedDrawable= VectorDrawableCompat.create(getResources(),R.drawable.chech_box_unchecked,context.getTheme());
